...
import com.javatechie.jwt.api.controller.WelcomeController;
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (userName != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtUtil.validateToken(token, userDetails)) {
                ...
                Optional<RefreshToken> request = refreshTokenRepository.findByToken(token);
                RefreshTokenRequest refreshTokenRequest = new RefreshTokenRequest();
                refreshTokenRequest.setToken(request.get().getToken());
  //              welcomeController.refreshToken(refreshTokenRequest);
            }
        }
